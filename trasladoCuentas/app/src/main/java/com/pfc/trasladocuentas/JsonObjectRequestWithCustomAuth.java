package com.pfc.trasladocuentas;
...
public class JsonObjectRequestWithCustomAuth  extends JsonObjectRequest {
    ...
    public JsonObjectRequestWithCustomAuth(
            int method, String url, @Nullable JSONObject jsonRequest, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener,Context context) {
